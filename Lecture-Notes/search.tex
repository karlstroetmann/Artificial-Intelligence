...
thieves have to cross a river.  Each of the thieves has a bag of gold coins.
\begin{enumerate}
...
Write a program that formulates this puzzle as a search problem.  You should do this by augmenting the notebook
\ \blue{\texttt{Three-Thieves.ipynb}} \ that can be found in the github repository
\\[0.2cm]
\hspace*{1.3cm}
\href{https://github.com/karlstroetmann/Artificial-Intelligence}{http://github.com/karlstroetmann/Artificial-Intelligence}
\\[0.2cm]
in the directory
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/Python/Chapter-01/02-Three-Thieves.ipynb}{Python/Chapter-01/02-Three-Thieves.ipynb}. 
\eox
...
this problem on my computer\footnote{
  My computer is a Mac Studio from 2022.  This machine is equipped with 64 Gigabytes of main memory and an
...
\item The function \texttt{bfs\_one\_step} takes four arguments:
      ...
      function just updates the set \texttt{Frontier} to contain those states that can be
...
\item Which of the algorithms we have discussed are suitable to solve this problem?
...
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/Python/Chapter-01/14-Eight-Queens-Puzzle.ipynb}{Artificial-Intelligence/blob/master/Python/Chapter-01/14-Eight-Queens-Puzzle.ipynb}.
...
\\[0.2cm]
\hspace*{1.5cm}
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/Python/Chapter-01/15-Taoistic-Search.ipynb}{\texttt{Python/Chapter-01/15-Taoistic-Search.ipynb}}
\\[0.2cm]
