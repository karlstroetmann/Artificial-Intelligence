...
can attack my moving horizontally, vertically, or diagonally.  Reformulate the \blue{eight queens puzzle} and
solve the puzzle via breadth first search.  For extra credit, compute all 92 solutions of the eight queens
puzzle.  
...
column 4, and so on.  The start state would then be the empty list and given a state $L$ all states form the
...
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/SetlX/sliding-puzzle-frame.stlx}{\texttt{\footnotesize
    https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/SetlX/queens-frame.stlx}}
\\[0.2cm]
