...
the notion of a \blue{search problem}.  We will use the
...
\begin{Definition}[Search Problem]
  ...
  A path $[s_1, \cdots, s_n]$ is a \blue{solution} to the search problem $P$ iff \index{search problem, solution}
...
\item Line 1 defines the auxiliary function \texttt{problem}.
      ...
      infidels. 
\item Line 3 defines the auxiliary function \texttt{noProblem}.
...
is similar to the $3 \times 3$ sliding puzzle but it is played on a square board of size 4
