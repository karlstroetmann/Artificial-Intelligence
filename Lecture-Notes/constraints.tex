...
The procedure $\texttt{backtrack\_search}$ shown in \myFig{Constraint-Propagation-Solver.ipynb:backtrack_search} is called with a
...
\end{figure}
\myFig{Constraint-Propagation-Solver.ipynb:most_constrained_variable} show the implementation of the procedure
...
for the variable $y$.  Formally, we define: \blue{A value $v$ is consistent for $x$ with respect to the constraint $f$} 
