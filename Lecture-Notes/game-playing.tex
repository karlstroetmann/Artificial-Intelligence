...
satisfies this specification.  Once the function $\texttt{alphaBeta}$ is implemented, the function $\texttt{value}$ can then
...
specification given above can be established by computational induction.  The next exercise asks for
this proof. 
