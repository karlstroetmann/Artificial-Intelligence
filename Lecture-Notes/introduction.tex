...
\ac{ai}) we should ask ourselves what we mean by the phrase ``\blue{artificial intelligence}''.
...
\begin{enumerate}
\item The common theme of the first part symbolic AI is \blue{declarative programming}.  
...
\remark
The programs presented in these lecture notes are expected to run with the \textsl{Python} version 3.8.
The file 
\\[0.2cm]
\hspace*{-0.3cm}
