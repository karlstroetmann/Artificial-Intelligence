...
\\[0.2cm]
then the $j$-th feature is a \blue{binary feature}.  For example, in the case of spam detection, the first feature
...
\\[0.2cm]
for most objects of $o \in S$ but not for all values.  The \blue{accuracy} of our model is then defined as the fraction
