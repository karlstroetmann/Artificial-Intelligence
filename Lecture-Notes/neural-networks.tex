...
\item The computing power that is available today has vastly increased in the last 20 years.
      ...
      like the \textsc{Nvidia} Blackwell B200 Tensor Core GPU that are can achieve more than a
      petaflop when training neural networks.  Furthermore, these card can be bundled
