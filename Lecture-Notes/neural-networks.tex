...
$n$ only reverse mode automatic differentiation is a viable option.  We proceed the crucial notion of a
computational graph. 
...
\begin{Definition}[Parent]
  ...
  of the nodes that are labelled with $a_1$ and $a_2$.  Furthermore, if $\langle v, o, a\rangle$ is a node in
