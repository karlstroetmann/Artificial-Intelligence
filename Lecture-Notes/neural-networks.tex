...
As the backpropagation equations are at the very core of training neural networks, we highlight them:
\\[0.2cm]
\hspace*{0.3cm}
...
Figure \ref{fig:mnist_imgs} shows the first 10 images visualized. The digits above the squares are
only added as visual aid, they are not part of the data.\\
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c c c c c}
      \includegraphics[width=2cm]{figures/mnist/0} &
      \includegraphics[width=2cm]{figures/mnist/1} &
      \includegraphics[width=2cm]{figures/mnist/2} &
      \includegraphics[width=2cm]{figures/mnist/3} &
      \includegraphics[width=2cm]{figures/mnist/4} \\
      \includegraphics[width=2cm]{figures/mnist/5} &
      \includegraphics[width=2cm]{figures/mnist/6} &
      \includegraphics[width=2cm]{figures/mnist/7} &
      \includegraphics[width=2cm]{figures/mnist/8} &
      \includegraphics[width=2cm]{figures/mnist/9}
    \end{tabular}
  \end{center}
  \caption{The first 10 images of the MNIST Dataset visualized}
