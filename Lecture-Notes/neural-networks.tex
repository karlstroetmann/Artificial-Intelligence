...
it has only been widely understood an accepted in recent years, cf.~Baydin et.~al.~\cite{baydin:2018}.
...
\blue{adjoint}, which is given next.  
...
\href{https://en.wikipedia.org/wiki/Chain_rule#Multivariable_case}{chain rule} of functions depending on
multiple variables.
...
$x_n$ to their values. Figure \ref{fig:Reverse-Mode-AD.ipynb:auxiliary} contains a number of auxiliary functions.
