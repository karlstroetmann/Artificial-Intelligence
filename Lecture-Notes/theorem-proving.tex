...
\begin{Theorem}[\href{https://en.wikipedia.org/wiki/Church–Rosser_theorem}{Church-Rosser}]
...
To begin, we first consider the cases where a syntactical equation $s \doteq t$ is unsolvable.
...
\\[0.2cm]
This syntactical equation is unsolvable because $f(t_1,\cdots,t_n)\sigma$ will always contain at least one more
function symbol than $x\sigma$.
...
pair of the form $\langle \{\}, \sigma \rangle$.  In this case  $\sigma$ is a unifier of the system of
...
\item If  $y\in\mathcal{V}$ is a variable that does  \underline{\color{red}not} occur in the term $t$, then
      ...
      \[ \Big\langle E \cup \big\{ y \doteq t \big\}, \sigma \Big\rangle \quad\leadsto\quad 
         \Big\langle E\{y \mapsto t\}, \sigma\{ y \mapsto t \} \Big\rangle 
      \]
...
\item The pair $\langle E, \{\} \rangle$ is reduced into a pair of the form $\langle \{\}, \sigma\rangle$.
      Then $\sigma$ is a  \blue{unifier} of $E$.  In this case we write $\sigma = \mathtt{mgu}(E)$.
      If $E = \{ s \doteq t \}$, we write $\sigma = \mathtt{mgu}(s, t)$.  The abbeviation
...
\begin{Definition}[Critical Pair] \hspace*{\fill} \\
  \index{critical pair}
  A pair of $\Sigma$-terms $\langle s, t\rangle$ is a \blue{critical pair} of the equation $l_1 \approx r_1$ and
