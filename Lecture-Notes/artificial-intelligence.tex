...
\title{\epsfig{file=Figures/dhbw-logo.eps, scale=1.5}\\[0.3cm]
       An Incomplete Introduction to Artificial Intelligence \\[0.3cm]
}
...
\\[0.2cm]
clones the repository containing the lecture notes and stores them on your local drive.
...
\\[0.2cm]
\hspace*{1.3cm}
\href{mailto:karl.stroetmann@dhbw.de}{\texttt{karl.stroetmann@dhbw.de}}
\\[0.2cm]
...
\include{automatic-differentiation}
