...
\newcommand{\textts}[1]{\colorbox{sepia}{\texttt{#1}}}
...
inconsistencies, please contact me via \href{https://discordapp.com}{discord} or, if that is not possible, email me: 
\\[0.2cm]
\hspace*{1.3cm}
\href{mailto:karl.stroetmann@dhbw-mannheim.de}{\texttt{karl.stroetmann@dhbw-mannheim.de}}
\\[0.2cm]
I am currently rewriting these lecture notes as I am moving from the programming language
\href{https://randoom.org/Software/SetlX/}{\textsc{SetlX}} to
\href{https://python.org}{\textsl{Python}}. 
\end{minipage}
}
