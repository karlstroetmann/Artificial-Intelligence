...
\item The member variable \texttt{mHiddenSize}, specifies the number of neurons in the hidden layer.  We assume that
      ...
      \begin{enumerate}[(a)]
      \item For 30 neurons, the computation took about 1 minutes and 39 seconds and the trained neural network achieved an
            accuracy of $96.0\symbol{37}$.
      \item For 60 neurons, the computation took 2 minutes and 15 seconds the network achieved an accuracy of
            $97.2\symbol{37}$.
      \item If there are 100 neurons in the hidden layer, the computation took 3 minutes and 16 seconds and achieved an
