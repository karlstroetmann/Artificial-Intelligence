...
The sigmoid function is also known as the \blue{logistic function}.
\eox
\end{Definition}
...
\\[0.2cm]
where $\mu_C$ is the \blue{mean value} of the feature $f$ for those objects that have class $C$, while
$\sigma_C^2$ is the \blue{variance} of $f$ for objects of class $C$.
