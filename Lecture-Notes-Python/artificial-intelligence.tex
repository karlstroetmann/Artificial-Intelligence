...
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/Lecture-Notes-Python/}{Lecture-Notes-Python} in
the file
\href{https://github.com/karlstroetmann/Artificial-Intelligence/blob/master/Lecture-Notes-Python/artificial-intelligence.pdf}{artificial-intelligence.pdf}.
...
\href{https://github.com}{\texttt{github}}.  As this is the third time that I give this lecture, these lecture
notes are still incomplete and will be changed frequently during the semester.  If you find any typos, errors, or
inconsistencies, please contact me via \href{https://discordapp.com}{discord} or, if that is not possible, email me at: 
\\[0.2cm]
\hspace*{1.3cm}
\href{mailto:karl.stroetmann@dhbw-mannheim.de}{\texttt{karl.stroetmann@dhbw-mannheim.de}}.
\\[0.2cm]
I am currently rewriting these lecture notes as I am moving from the programming language \textsc{SetlX} to \textsl{Python}.
\end{minipage}
}
