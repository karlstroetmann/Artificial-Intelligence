...
\blue{miles per gallon}of a car, i.e.~the number of miles a car can go with one gallon of gas.  Note that
...
\\[0.2cm]
contains data about cherry trees.

advertising.  Concretely, let us think that this data lists the amount of money that has
